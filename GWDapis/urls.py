...
urlpatterns = [
    ...
    path('districts/<str:district_id>/mandals/<str:mandal_name>/waterLevels', views.get_water_levels, name='get_water_levels'),
    path('districts/<str:district_id>/mandals/<str:mandal_name>/waterQuality', views.get_water_quality, name='get_water_quality'),
]